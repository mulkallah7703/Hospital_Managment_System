<%@ Page Title="Edit Medical Record" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Edit.aspx.cs" Inherits="HospitalManagementSystem.Web.MedicalRecordsEdit" %>
    ...
    <asp:Panel ID="pnlForm" runat="server" CssClass="form-card">
        <div class="form-row">
            ...
            <div class="readonly-value">
                <asp:Label ID="lblRecordID" runat="server" />
            </div>
        </div>
        ...
        <div class="actions">
            <asp:Button ID="btnUpdate" runat="server" Text="Update" CssClass="btn"
                OnClick="btnUpdate_Click" ValidationGroup="MedicalRecordForm" />
