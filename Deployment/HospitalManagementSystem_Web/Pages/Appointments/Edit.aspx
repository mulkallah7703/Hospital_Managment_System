<%@ Page Title="Edit Appointment" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Edit.aspx.cs" Inherits="HospitalManagementSystem.Web.AppointmentsEdit" %>
    ...
    <asp:Panel ID="pnlForm" runat="server" CssClass="form-card">
        ...
        <div class="actions">
            <asp:Button ID="btnUpdate" runat="server" Text="Update" CssClass="btn"
                OnClick="btnUpdate_Click" ValidationGroup="AppointmentForm" />
