<%@ Page Title="Bills" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="List.aspx.cs" Inherits="HospitalManagementSystem.Web.BillsList" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    <style>
        ...
        .bills-grid { width: 100%; border-collapse: collapse; background: #fff; }
        .bills-grid th { background: #0d6efd; color: #fff; padding: 10px; text-align: left; }
        .bills-grid td { padding: 10px; border-bottom: 1px solid #e5e7eb; }
        .bills-grid tr:nth-child(even) { background: #f8fafc; }
    </style>

    <div class="page-header">
        <h2>Bills</h2>
        <asp:HyperLink ID="lnkAdd" runat="server" NavigateUrl="Add.aspx" CssClass="btn" Text="Add Bill" />
    </div>

    <asp:Label ID="lblMessage" runat="server" EnableViewState="false" /><br />

    <div class="toolbar">
        <asp:TextBox ID="txtSearch" runat="server" CssClass="search-box" placeholder="Search by patient or payment status" />
    ...
    <asp:GridView ID="gvBills" runat="server"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="BillDateText" HeaderText="Bill Date" />
            <asp:TemplateField HeaderText="Actions">
                <ItemTemplate>
                    <asp:HyperLink ID="lnkEdit" runat="server"
                        CssClass="btn-edit"
                        Text="Edit"
                        NavigateUrl='<%# "Edit.aspx?id=" + Eval("BillID") %>' />
                    <asp:Button ID="btnDelete" runat="server"
                        CssClass="btn-danger"
                        Text="Delete"
                        CommandName="DeleteBill"
                        CommandArgument='<%# Eval("BillID") %>'  CausesValidation="false" />
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
